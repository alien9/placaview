...
class SignsEditor(QDialog, FormClass):
    ...
    def __init__(self, *args, **kwargs):
        ...
        boulder: QgsGeometry = EquidistanceBuffer().buffer(
            kwargs.get("selected_sign").geometry(), 35, kwargs.get('signs_layer').crs()
        )
    ...
    def connect_signals(self):
        ...
        self.findChild(QPushButton, "pushButton_forward").clicked.connect(self.forward)
        self.findChild(QPushButton, "pushButton_back").clicked.connect(self.backward)
